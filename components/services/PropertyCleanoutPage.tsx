        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-8">
            ...
            <div className="border-t border-gray-200 pt-6">
              <h3 className="text-lg font-light text-gray-900 tracking-tight mb-5">Estate Cleanouts</h3>
            ...
            <div className="border-t border-gray-200 pt-6">
              <h3 className="text-lg font-light text-gray-900 tracking-tight mb-5">Foreclosures</h3>
              <ul className="space-y-2.5 text-gray-500 text-sm">
            ...
            <div className="border-t border-gray-200 pt-6">
              <h3 className="text-lg font-light text-gray-900 tracking-tight mb-5">Move-Outs</h3>
              <ul className="space-y-2.5 text-gray-500 text-sm">
            ...
            <div className="border-t border-gray-200 pt-6">
              <h3 className="text-lg font-light text-gray-900 tracking-tight mb-5">Hoarding Situations</h3>
              <ul className="space-y-2.5 text-gray-500 text-sm">
      ...
      <section className="py-24 md:py-32 bg-white border-t border-gray-100">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 pt-8 border-t border-gray-200">
            <div>
              <h3 className="text-xl font-light text-gray-900 tracking-tight mb-3">Compassionate & Discreet</h3>
            ...
            <div>
              <h3 className="text-xl font-light text-gray-900 tracking-tight mb-3">Complete Cleanouts</h3>
              <p className="text-gray-500 leading-relaxed">
