      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-secondary tracking-tight mb-4 md:mb-6 leading-[1.05] animate-slide-up" style={{animationDelay: '0.1s'}}>
              Junk gone.
              <br/>
              Today.
            </h1>
            
            <p className="text-sm sm:text-base md:text-lg text-secondary mb-6 md:mb-8 max-w-lg leading-relaxed animate-slide-up" style={{animationDelay: '0.2s'}}>
