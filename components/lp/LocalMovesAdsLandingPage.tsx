...
const approaches = [
  {
    title: 'Easy Booking',
    body: 'Book local movers online in minutes — truck + crew or labor only.',
  },
  {
    title: 'From $99/Hour',
    body: 'Starting at $99/hour for 2 moving helpers. Clear hourly rates before you confirm.',
  },
  {
    title: 'Right-Sized Crews',
    body: 'Built for studios, apartments, and small local jobs — not oversized long-haul vans.',
  },
  {
    title: 'Truck Optional',
    body: 'Need a truck? Book crew + vehicle. Already have one? Hire helpers only.',
  },
  {
    title: 'Same-Day Options',
    body: 'Same-day and next-day windows when capacity allows in your area.',
  },
  {
    title: 'Vetted Providers',
    body: 'Background-checked local movers matched to your short-distance move.',
  },
];

/** Standalone Google Ads landing page for local moves — not the public services page. */
export const LocalMovesAdsLandingPage: React.FC = () => {
  ...
  const goToQuote = () => {
    navigate('/quote', { state: { serviceType: 'Moving Labor' } });
  };
  ...
  return (
    <div className="home-dark">
          ...
          <div className="w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] items-center gap-8 md:gap-6 lg:gap-10">
            <div className="relative z-10 max-w-xl md:max-w-none">
              ...
              <h1 className="font-sans font-extrabold text-[2.35rem] sm:text-[3.2rem] md:text-[3.5rem] lg:text-[3.85rem] leading-[1.06] tracking-tight text-white mb-4 sm:mb-5 animate-fade-in-up delay-100">
                Local Moves From
                <br className="hidden sm:block" /> $99/Hour
              </h1>
              ...
              <p className="text-[14px] sm:text-base md:text-lg leading-relaxed text-[var(--text-muted)] mb-6 sm:mb-7 max-w-md animate-fade-in-up delay-200">
                2 moving helpers from $99/hour. Studios, apartments, and short-distance jobs — truck + crew or labor only.
              </p>
                ...
                <div className="flex items-start gap-2.5">
                  ...
                  <div>
                    <p className="text-[14px] sm:text-[15px] font-bold text-[var(--text)] leading-tight">
                      In-town moves only — from $99/hr
                    </p>
                    <p className="text-[12px] sm:text-[13px] text-[var(--text-muted)] mt-0.5">
                      Book online in minutes. No long-distance. No oversized truck markup.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="relative justify-self-center md:justify-self-end w-full max-w-[380px] sm:max-w-[520px] md:max-w-[580px] lg:max-w-[640px] -mx-2 sm:mx-0 animate-fade-in delay-200">
              ...
              <img
                src="/opek-related-moving.png?v=1"
                alt="Moving providers carrying furniture for a local move"
      ...
      <section className="relative bg-[var(--bg-alt)] border-t border-[var(--border)] overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-12 min-h-0 lg:min-h-[480px]">
          <div className="relative order-2 lg:order-1 lg:col-span-5 flex items-end justify-center px-6 pt-4 sm:pt-6 lg:pt-8 pb-0 overflow-hidden min-h-[280px] sm:min-h-[340px] lg:min-h-[360px]">
            ...
            <img
              src="/opek-related-local-moves.png?v=1"
              alt="Provider loading boxes into a cargo van for a local move"
          ...
          <div className="relative order-1 lg:order-2 lg:col-span-7 flex items-center px-5 sm:px-8 lg:px-12 xl:px-16 pt-12 sm:pt-14 md:pt-16 pb-6 sm:pb-8 lg:py-16">
            <div className="max-w-xl w-full">
              <p className="text-[13px] sm:text-sm font-semibold text-brand mb-3">Local moves, no bloat</p>
              <h2 className="font-sans font-extrabold text-[1.75rem] sm:text-[2.25rem] md:text-[2.5rem] text-[var(--text)] tracking-tight leading-[1.1] mb-4 sm:mb-5">
                2 helpers from $99/hour — sized for small jobs
              </h2>
              <p className="text-[14px] sm:text-base text-[var(--text-muted)] leading-relaxed mb-6">
                Big movers overcharge studios and apartments. Opek matches you with local providers for
                short-distance moves — hourly pricing, truck optional, no long-haul markup.
              </p>
              <blockquote className="border-l-2 border-brand pl-4 sm:pl-5 mb-8">
                <p className="text-[14px] sm:text-[15px] text-[var(--text)] leading-relaxed">
                  Starting at <span className="font-bold text-brand">$99/hour for 2 moving helpers</span>.
                  Book online or call — in-town moves only.
                </p>
              </blockquote>
              <button
                type="button"
      ...
      <ZipFinder
        ...
        subtitle="Enter your ZIP — we’ll connect you with local providers for short-distance moves."
        buttonLabel="Find Local Movers Near Me"
        pricingHref={null}
      />
    </div>
  );
