          ...
          <div>
            ...
            <div className="relative group">
              ...
              <textarea
                ...
                className="w-full pl-10 pr-4 py-3 bg-white border border-secondary-200 rounded-lg text-sm text-secondary placeholder:text-secondary-300 focus:outline-none focus:ring-1 focus:ring-brand focus:border-brand transition-colors resize-none"
              />
            </div>
          </div>
