          ...
          <div className="w-full lg:max-w-md shrink-0">
            <div className="flex flex-col sm:flex-row gap-2.5">
              <input
                ...
                className="flex-1 px-4 py-3 text-sm bg-white border border-secondary-200 rounded-lg text-secondary placeholder:text-secondary-300 focus:outline-none focus:ring-2 focus:ring-brand/20 focus:border-brand transition-colors font-mono tracking-wider"
              />
              <button
                onClick={handleZipCheck}
                disabled={zipCode.length !== 5 || isLoading}
                className="px-6 py-3 bg-secondary hover:bg-brand text-white font-bold text-sm uppercase tracking-wider rounded-lg transition-colors disabled:opacity-40 disabled:cursor-not-allowed inline-flex items-center justify-center gap-2 whitespace-nowrap"
              >
                {isLoading ? (
