...
for (const file of files) {
  ...
  content = content.replace(/p-5 border-2 rounded-none/g, 'p-5 border rounded-none');
  ...
  content = content.replace(/bg-secondary-50 text-secondary-400 group-hover:bg-brand\/10 group-hover:text-brand/g,
    'bg-white text-secondary-400 group-hover:text-brand');
    
  content = content.replace(/w-5 h-5 border-2 rounded-none/g, 'w-5 h-5 border rounded-none');
  ...
  content = content.replace(/w-4 h-4 border-2 rounded-none/g, 'w-4 h-4 border rounded-none');
  ...
  content = content.replace(/w-10 h-10 bg-secondary-50/g, 'w-10 h-10 bg-white');
  ...
  // Booking Page fields
  content = content.replace(/bg-secondary-50 border border-secondary-100 focus:ring-2 focus:ring-brand\/20 focus:border-brand/g,
